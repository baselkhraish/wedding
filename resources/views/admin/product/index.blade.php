            ...
            <div class="col-xl-12">
                ...
                <div class="card card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('admin.product.create') }}" class="btn btn-sm btn-primary">إضافة منتج</a>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                    @if ($item->sale_price)
                                                        <p class="text-dark fw-bolder text-hover-primary fs-6">{{ $item->sale_price }}</p>

                                                    @else
                                                        <p class="text-dark fw-bolder text-hover-primary fs-6">{{ $item->price }}</p>
                                                    @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <p class="fw-bolder fs-6 badge badge-primary text-white">{{ $item->qty }}</p>
                                        </td>
