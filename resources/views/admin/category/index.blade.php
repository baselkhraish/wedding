                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-bold fs-7">{{ $category->count() }} قسم</span>
                            </h3>
                        </div>
                        <div>
                            ...
                            <table class="table table-hover table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                ...
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        <th class="w-25px">#</th>
                                        <th class="min-w-200px">المنشئ</th>
                                        <th class="min-w-200px">صورة القسم</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-dark fw-bolder text-hover-primary fs-6"><img src="{{ asset('uploads/images/category/'.$item->image) }}" alt="{{ $item->name }}" style="width: 50px;"></p>
                                        </td>
