<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="{{ route('admin.index') }} ">
            <img alt="Logo" src="{{ asset('adminasset/assets/media/logos/logo-1-dark.svg') }}"
                class="h-25px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                {{-- Order Admin --}}
                @if (Auth::user()->status == 'vendor' )
                <div class="menu-item {{ Route::is('admin.order_vendor') ? 'here show' : '' }}">
                    <a class="menu-link py-3 {{ Route::is('admin.order_vendor') ? 'active' : '' }}"
                        href="{{ route('admin.order_vendor') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                {{-- Order Admin --}}
                @if (Auth::user()->status == 'admin' )
                <div class="menu-item {{ Route::is('admin.order_admin') ? 'here show' : '' }}">
                    <a class="menu-link py-3 {{ Route::is('admin.order_admin') ? 'active' : '' }}"
                        href="{{ route('admin.order_admin') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                @if (Auth::user()->status == 'vendor' && $vendor->status === 'accepted')
                    <div data-kt-menu-trigger="click"
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Route::is('admin.product.create') ? 'active' : '' }}"
